  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: 'Reports',
        icon: BarChart3,
        description: 'Profitability by category and item-level sales movers.',
        perm: 'report:read',
      },
      {
        to: '/admin/people',
        label: 'People',
        icon: Users,
        description: 'Members, staff profiles and the roles that grant access.',
        anyOf: ['member:read', 'staff:read', 'role:read'],
      },
      {
        to: '/admin/activity',
        label: 'Activity',
      ...
      },
      {
        ...
        label: 'Settings',
        icon: SettingsIcon,
        description: 'Branding, preferences, plan & usage, and integrations.',
        perm: 'tenant:update',
      },
    ],
  },
