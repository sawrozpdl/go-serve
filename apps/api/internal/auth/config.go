...
// startup (google env vars present, APP_ENV=dev, mailer configured) — they
// don't change between requests.
func ConfigHandler(googleEnabled, devLoginEnabled, emailOtpEnabled bool) http.HandlerFunc {
	body := struct {
		GoogleEnabled   bool `json:"google_enabled"`
		DevLoginEnabled bool `json:"dev_login_enabled"`
		EmailOtpEnabled bool `json:"email_otp_enabled"`
	}{googleEnabled, devLoginEnabled, emailOtpEnabled}
